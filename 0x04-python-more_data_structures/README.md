...
Project done during **Software Engineering program** at **ALX**. It aims to learn about sets, dictionaries and functions such as the lambda, map, reduce and filter functions in **Python**.
