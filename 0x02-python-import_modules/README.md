...
It aims to learn how to import functions and use them, use buit-in functions, create modules,
prevent imported code from executing and how to  use command line arguments in **Python**
